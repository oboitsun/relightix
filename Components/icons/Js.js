...
export default function Js() {
  return (
    <svg className='fill-current w-16' version='1.1' viewBox='0 0 512 512'>
      <g id='_x31_87-js'>
        <g>
          <rect height='459.998' fill='current' width='459.996' x='26.002' y='26.001' />
          <path
            ...
            className='fill-current filter invert'
          />
          <path
